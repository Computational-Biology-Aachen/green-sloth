...
- What if the apparatus diagram _was_ the whole "Part of Photosynthesis" filter — no pill duplicate at all — and became the page's one flagship IA element instead of one of four parallel filter systems?
