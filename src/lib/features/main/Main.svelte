<script lang="ts">
  ...
  let citationAuthors =
    "Elouen Corvest, Marvin van Aalst, Tim Nies, Quang Huy Nguyen, Josha Ebeling, Maja Strauch, El-Hadji Malick Cisse, Tanvir Hassan, Anna Matuszyńska";
...
>
  ...
  <Text>
    ...
    {citationAuthors}. <i>{citationJournal}</i>;
    <a
      href={citationDOI}
      target="_blank">{citationDOI}</a
    >
  </Text>
