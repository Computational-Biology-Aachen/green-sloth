The [Johnson & Berry (2021)](https://doi.org/10.1007/s11120-021-00840-4) model is a mechanistic, steady-state framework
designed to extend the classical Farquhar, von Caemmerer, and Berry (FvCB) model of $C_3$ leaf photosynthesis.
...
The Cytochrome $b_6f$ ($Cyt\ b_6f$) complex serves as a primary kinetic regulatory bottleneck—acting as a metabolic switch
...
acts via feedback loop to down-regulate plastoquinol oxidation at the $Cyt\ b_6f$ complex. This process occurs rapidly to protect Photosystem I (PSI)
...
purely under steady-state assumptions. The model translates four primary environmental input variables (Temperature, Light, $CO_2$, and $O_2$) into functional photosynthetic metrics.
